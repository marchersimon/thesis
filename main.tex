...
... to \textbf{Federico Marotta} for providing \enquote{kaobook}, the \LaTeX{} document class this thesis is built upon. It is licensed under the \href{https://www.latex-project.org/lppl/lppl-1-3c/}{LPPL-1.3c} and can be found on Github (QR code \newqrcode{https://github.com/fmarotta/kaobook}{Kaobook Template}).

... to various open source projects, like PlatformIO, fritzing, WebPlotDigitizer and some more
