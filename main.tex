...
%%%%% Fix spaces after sidenote references

\newcommand{\sidenotes}[1]{\sidenote{#1}\hspace{-1mm}}
...
\newcommand{\printqrcodes}{%
  \chapter*{List of QR codes}
  \addcontentsline{toc}{chapter}{List of QR codes}
...
\setlength{\textheight}{21cm} % Manually adjust the height of the ToC pages
...
\newcommand{\simon}{
    \pagelayout{wide}
    \addpart[The Tesla Coil]{\parbox{\textwidth}{\centering The Tesla Coil\\[4mm]\large \normalfont by Simon Marcher}}
    \pagelayout{margin}
...
\newcommand{\kassandra}{
    \pagelayout{wide}
    \addpart[Design and Building]{\parbox{\textwidth}{\centering Design and Building\\[4mm]\large \normalfont by Kassandra Peyer}}
    \pagelayout{margin}
    \input{kassandra/main.tex}
}

\newcommand{\felix}{
    \pagelayout{wide}
    \addpart[MIDI Interrupter]{\parbox{\textwidth}{\centering MIDI Interrupter\\[4mm]\large \normalfont by Felix Hamrle}}
    \pagelayout{margin}
...
\addcontentsline{toc}{chapter}{Special Thanks}

... to our supervisors, consultants, and sponsors Thomas Jerman und Michael Lieschnegg.

... to our workshop teachers, especially Hubert Tuscher, Albin Waiker and Konrad Wilhelm.

... to Federico Marotta for providing \enquote{kaobook}, the \LaTeX{} document class this thesis is built upon. It is licensed under the \href{https://www.latex-project.org/lppl/lppl-1-3c/}{LPPL-1.3c} and can be found on GitHub (QR code \newqrcode{https://github.com/fmarotta/kaobook}{Kaobook Template}).

... to various open source projects, like PlatformIO, fritzing, WebPlotDigitizer, MIDIopsy, and many more.

... to every kind soul on this world.

%... to \textbf{Overleaf} for taking so long to compile documents, that we had plenty of time to reconsider our wording.

%... to our headmaster \textit{Hofrat Günter Schweigler}. Just kidding.
