...
\begin{tikzpicture}
    ...
    \fill[gr20] (\outerradius + 5mm, \barypos{4}) rectangle ++(\barlength, \barheight)  node[gr70, yshift=-\barheight/2, xshift=3mm]{\faIcon[regular]{magnet}};
    \fill[gr50] (\outerradius + 5mm, \barypos{4}) rectangle ++(\barlength * 0.1 * #3, \barheight);
    
    \fill[gr20] (\outerradius + 5mm, \barypos{3}) rectangle ++(\barlength, \barheight)  node[gr70, yshift=-\barheight/2, xshift=3mm]{\faIcon[regular]{fire}};
    \fill[gr50] (\outerradius + 5mm, \barypos{3}) rectangle ++(\barlength * 0.1 * #4, \barheight);

    \fill[gr20] (\outerradius + 5mm, \barypos{2}) rectangle ++(\barlength, \barheight)  node[black!70, yshift=-\barheight/2, xshift=3mm]{\faIcon[regular]{euro-sign}};
    \fill[gr50] (\outerradius + 5mm, \barypos{2}) rectangle ++(\barlength * 0.1 * #5, \barheight);

    \fill[gr20] (\outerradius + 5mm, \barypos{1}) rectangle ++(\barlength, \barheight)  node[gr70, yshift=-\barheight/2, xshift=3mm]{\faIcon[regular]{eye}};
    \fill[gr50] (\outerradius + 5mm, \barypos{1}) rectangle ++(\barlength * 0.1 * #6, \barheight);

    \foreach \l in {1,...,4}{
      \foreach \p in {1,...,9}{
        \draw[gr20, ultra thick] (\outerradius + 5mm + \barlength / 10 * \p, \barypos{\l}) -- ++(0, \barheight);
      }
    }
