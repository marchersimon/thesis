...
\begin{figure}[h!]
    ...
    \begin{tikzpicture}
      \begin{polaraxis}[
        ...
        \addplot[domain=0:20*pi, samples=500, color=red, data cs=polarrad] { 25 + 0.4775 * x };
      \end{polaraxis}
      \begin{polaraxis}[
        xmin = 90,
        xmax = 270,
        ...
        \addplot[domain=0:20*pi, samples=500, color=red, data cs=polarrad] { 326.56 - 248622 / (x+813.557) };   
    \end{polaraxis}
\end{tikzpicture}}
    \caption{AAA}
    \label{fig:spirals}
